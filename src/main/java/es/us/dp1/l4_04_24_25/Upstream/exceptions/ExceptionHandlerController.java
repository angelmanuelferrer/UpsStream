...
public class ExceptionHandlerController {
	...
	@ExceptionHandler(ErrorTile.class)
	@ResponseStatus(value = HttpStatus.BAD_REQUEST)
	public ResponseEntity<ErrorMessage> globalExceptionHandler(ErrorTile ex, WebRequest request) {
...
//	}	
	...
	public ResponseEntity<ErrorMessage> handleAccessDeniedException(AccessDeniedException ex, WebRequest request) {
	 ...
	 @ExceptionHandler(value = GameLimitException.class)
    @ResponseStatus(HttpStatus.BAD_REQUEST)
    public ResponseEntity<ErrorMessage> handleInvalidCardPlayException(
        GameLimitException ex,
        WebRequest request
    ) {
