...
export default function useFetchState(initial, url, jwt, setMessage, setVisible, id = null) {
    ...
    useEffect(() => {
        // Set interval outside URL check to ensure it runs every 4 seconds
        ...
        if (url && (!id || id !== "new")) {
            ...
            // Cleanup to cancel fetch updates and interval when URL or ID changes
            return () => {
                ignore = true;
        ...
        // Cleanup on unmount to clear interval even if URL is null
